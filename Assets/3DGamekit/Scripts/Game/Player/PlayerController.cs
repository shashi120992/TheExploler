...
namespace Gamekit3D
{
    ...
    public class PlayerController : MonoBehaviour, IMessageReceiver
    {
        ...
        public void SavePlrCtrlr()
        {
            SavePlayerDataCtrlr.savePlayerCtrlr(this);
        }

        public void loadPlrCtrlr()
        {
            PlayerDataCtrlr Ctrlr =  SavePlayerDataCtrlr.loadPlayerCtrlr();

            Vector3 posn;
            posn.x = Ctrlr.position[0];
            posn.y = Ctrlr.position[1];
            posn.z = Ctrlr.position[2];
